    ...
    addSession: (req, res) => {
        ...
        db.query(KeyQuery, [1, 2], (err, result) => {
            if (err) {
                ...
                let existingSessionQuery =  "SELECT * FROM `Session` WHERE RoomID = '" + RoomId + "' AND Title = '"+title+"' AND SpeakerID = '"+SpeakerID+"' AND TimePointID = '"+TimePointID+"'";
                ...
                db.query(existingSessionQuery, (err, result) => {
                    ...
                    if (result.length > 0) {
                        ...
                        let query = "INSERT INTO `Session` (Title, TimePointID, RoomID, SpeakerID) VALUES ('" +
